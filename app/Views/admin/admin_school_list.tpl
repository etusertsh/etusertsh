                                        ...
                                        {{foreach item=item from=$data}}
                                            <tr id="schooltr-{{$item.id}}"
                                                ...
                                                <td>{{if $item.classnum > 0}}
                                                    <input id="schoolcar-{{$item.id}}" type="number" min="0" step="1" value="{{$item.cars|default:'0'}}" class="form-control" onchange="schoolcars(this,'{{$item.id}}');"{{if $item.available == '0'}} readonly{{/if}}>
                                                    {{/if}}
                                                </td>
                                            </tr>
                                        {{/foreach}}
