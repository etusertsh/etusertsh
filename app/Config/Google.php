...
class Google extends BaseConfig
{
    ...
    public $redirectUri = 'https://etuser.hopto.org/klexpo/auth/oauth2callback'; //add your redirect uri
    public $apiKey = ''; //add your api key here
    public $applicationName ='Keelung City Expo 2022et'; //application name for the api
}
