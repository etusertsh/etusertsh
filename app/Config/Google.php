...
class Google extends BaseConfig
{
    ...
    public $redirectUri = 'https://etuser.hopto.org/sciproject/auth/oauth2callback'; //add your redirect uri
    public $apiKey = ''; //add your api key here
    public $applicationName ='Keelung Science Project System'; //application name for the api
}
